...
<p class="page_title"><?php echo COLOR_TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
		...
		<tr>
			...
			<div style="float:left;margin-right:0.5em">
				...
				for($i=0;$i<count($fetch);$i++){
				    $titel_edit =  mb_substr($fetch[$i]['COLOR_NAME'], 0, 20);
					echo "<option value=\"{$fetch[$i]['COLOR_CODE']}\">{$fetch[$i]['VIEW_ORDER']}：{$titel_edit}</option>\n";
				}?>
				</select>
			</div>
