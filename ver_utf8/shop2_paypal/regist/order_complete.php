...
if ( $PaymentOption == "PayPal" )
{
	...
	*/
	...
	$finalPaymentAmount =  $_SESSION["paypal"]["Payment_Amount"];
	...
	*/
	...
	$resArray = ConfirmPayment ( $finalPaymentAmount, $_SESSION["paypal"]["Order_Id"] );
	$ack = strtoupper($resArray["ACK"]);
	if( $ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING" )
	{
		...
		*/
		...
		$oid = $_SESSION["paypal"]["Order_Id"];
		$_SESSION["paypal"] = array();				// PayPal情報を破棄
		header("Location: ../regist.php?sendid=".$oid."&result=ok");	
	}
	else  
	{
		//Display a user friendly Error on the page using any of the following error information returned by PayPal
