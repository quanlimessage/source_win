...
define('SITE_LINK','http://'.$_SERVER["HTTP_HOST"]);	// サイトURL(httpからの絶対パス)

#=================================================================================
# ＤＢ接続の情報（定数化）
#=================================================================================
define('DB_SERVER','localhost');
define('DB_NAME','otherdemo');
define('DB_USER','otherdemo');
define('DB_PASS','yC8W6e5O');
define('DSN',"mysql://otherdemo:yC8W6e5O@localhost/otherdemo");	// PEAR用
