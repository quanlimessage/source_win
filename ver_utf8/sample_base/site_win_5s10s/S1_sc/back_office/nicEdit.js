...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'http://mx16.zeeksdg.net/zeeksdg/niceedit_test/nicEditorIcons.gif',
	convertToText : true,
...
//		if( e.contentEditable || !!window.opera ) {
	...
	getIcon : function(iconName,options) {
		...
		if (this.options.iconsPath != null && this.options.iconsPath == 'http://mx16.zeeksdg.net/zeeksdg/niceedit_test/nicEditorIcons.gif') {
		...
		switch(nType) {
			case 1:
				...
				if(!nChild) {
					...
					for(var i=0;i<n.childNodes.length;i++) {
						var results = this.toLegacyHTML(n.childNodes[i],true,true);
						if(results) {
							txt += results;
						}
					}
