...
// 設定ファイル＆共通ライブラリの読み込み
require_once("../../common/config_P1.php");	// 設定情報
...
<p class="page_title"><?php echo P1_TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
		...
		<table width="600" border="1" cellpadding="2" cellspacing="0" style="height:inherit;">
				...
				<tr class="<?php echo (($i % 2)==0)?"other-td":"otherColTd";?>">
					...
					<?php if(search_file_flg(S1_IMG_PATH,$fetch[$i]['RES_ID']."_1.*")):?>
						...
						<?php echo search_file_disp(S1_IMG_PATH,$fetch[$i]['RES_ID']."_1.*","border=\"0\" width=\"".P1_IMGSIZE_SX."\"");?>
						</a>
					<?php else:
						echo '&nbsp;';
					endif;?>
