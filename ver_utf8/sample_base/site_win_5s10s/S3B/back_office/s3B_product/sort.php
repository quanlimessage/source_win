...
// 設定ファイル＆共通ライブラリの読み込み
require_once("../../common/config_S3B.php");	// 設定情報
...
<p class="page_title"><?php echo S3B_TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
			...
			<tr class="<?php echo (($i % 2)==0)?"other-td":"otherColTd";?>">
				...
				<td align="center">
					<?php if(file_exists(S3B_IMG_PATH.$fetch[$i]['RES_ID'].'.jpg')):?>
						<img src="<?php echo S3B_IMG_PATH.$fetch[$i]['RES_ID'];?>.jpg?r=<?php echo rand();?>" border="0" width="<?php echo S3B_IMGSIZE_SX;?>">
					<?php else:?>
						&nbsp;
					<?php endif;?>
				</td>
