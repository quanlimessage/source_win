...
// 設定ファイル＆共通ライブラリの読み込み
require_once("../../common/config_W3.php");	// 設定情報
...
<p class="page_title"><?php echo W3_TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
	...
	<td width="50%" valign="top">
		<table width="100%" border="1" cellpadding="2" cellspacing="0" style="height:inherit;">
			<tr class="tdcolored">
				...
				<th width="10%" nowrap class="back2">ファイル</th>
			...
			<tr class="<?php echo (($i % 2)==0)?"other-td":"otherColTd";?>">
				...
				echo $title; ?></td>
				<td align="center">
					<?php if(file_exists(W3_IMG_PATH.$fetch[$i]['RES_ID'].".".$fetch[$i]['EXTENTION'])):?>
					<a href="<?php echo W3_IMG_PATH.$fetch[$i]['RES_ID'].".".$fetch[$i]['EXTENTION'];?>" target="_blank">
					<img src="./icon_img/icon_<?php echo $fetch[$i]['EXTENTION'];?>.jpg" border="0"></a>
					<?php else:?>&nbsp;<?php endif;?>
				</td>
		...
		<tr>
			...
			<div style="float:left;margin-right:0.5em">
				...
				for($i=0;$i<count($fetch);$i++){
					$title = mb_strimwidth($fetch[$i]['TITLE'], 0, 40, "...", utf8);
