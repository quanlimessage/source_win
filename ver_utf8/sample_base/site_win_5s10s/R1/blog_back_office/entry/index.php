...
require_once("../../common/ping/PingManager.php");    // 共通設定情報
require_once("../../common/ping/SendPing.php");    // 共通設定情報
...
case "completion":
    ...
    header("Location: {$_SERVER['PHP_SELF']}?category_code=".urlencode($category_code)."&p={$p}");
