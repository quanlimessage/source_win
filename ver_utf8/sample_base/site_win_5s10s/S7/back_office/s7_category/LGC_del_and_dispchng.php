...
// 該当データの完全削除
	...
	//カテゴリーのDELフラグを設定
	$PDO -> regist("UPDATE ".S7_CATEGORY_MST." SET DEL_FLG = '1' WHERE(CATEGORY_CODE = '$cate')");
...
// 表示/非表示の切替（フラグを更新）
	...
	// SQLを実行
	$PDO -> regist("UPDATE ".S7_CATEGORY_MST." SET DISPLAY_FLG = '$up_display' WHERE(CATEGORY_CODE = '$cate')");
