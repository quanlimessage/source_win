...
require_once("../tag_pg2/LGC_color_table.php");	// タグ処理のプログラム
require_once("../../common/class/class.FormBO.php");	// 共通設定情報
...
case "completion":
	...
	echo "3";
	if($_POST['copy_type']){
		include("LGC_rayout_regist.php");
		// ブロックIDの受け渡し
		$_POST['_block_res_id'] = $_b_res_ids;
	}

	include("LGC_block_regist.php");
	header("Location: ./?ca=".urlencode($ca)."&p=".urlencode($p));

	break;

case "rayout_completion":
...
//	更新画面出力
	...
	include("LGC_getDB-data.php");
	include("DISP_rayout_update.php");
...
//	新規登録画面出力
	...
	//include("DISP_rayout_newInput.php");
