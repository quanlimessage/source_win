...
// 記事リスト一覧用データの取得と
	...
	$sqlcnt = "
	SELECT
		".N3_S7_WHATSNEW.".RES_ID,
		".N3_S7_WHATSNEW.".TITLE,
		".N3_S7_WHATSNEW.".DISPLAY_FLG
	FROM
		".N3_S7_WHATSNEW."
		INNER JOIN
		".N3_S7_CATEGORY_MST."
		ON
		(".N3_S7_WHATSNEW.".CATEGORY_CODE = ".N3_S7_CATEGORY_MST.".CATEGORY_CODE)

	WHERE
		(".N3_S7_WHATSNEW.".DEL_FLG = '0')
		AND
