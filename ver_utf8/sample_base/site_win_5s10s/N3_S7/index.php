...
<div id="content">
   ...
   <ul id="menu">
	...
	<div id="main">
		<div id="index_image"><br><br><br><br><br><br><h5>Winシリーズ★更新プログラム<br><br>サンプルサイト&nbsp;10･20･30<br><br><br>新着情報（Ｎ３－Ｓ７）&nbsp;リンク形式<br><br>
		<br><br></h5></div>
		<div id="news">
			...
			<dl>
				...
				<dd>
					...
					if($link[$i]){
						if($link_flg[$i] == 1){
							echo "<a href='./news_N3_S7/?ca={$ca[$i]}&p={$p[$i]}#{$id[$i]}'>{$title[$i]}</a>";
						}
						elseif($link_flg[$i] == 2){
