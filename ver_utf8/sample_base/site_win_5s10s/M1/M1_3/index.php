...
<?php
	...
	<form method="post" action="./authorise.php">
		<table width="300" border="1">
			...
			<tr>
				<td width="100">ID</td>
				<td width="200" align="left"><input type="text" name="login_id" size="20" maxlength="10" style="ime-mode:disabled;width: 150px;height: 15px;"></td>
			</tr>
			<tr>
				<td width="100">PASSWORD</td>
				<td width="200" align="left"><input type="password" name="login_pw" size="20" maxlength="10" style="ime-mode:disabled;width: 150px;height: 15px;"></td>
			</tr>
			<tr>
				<td colspan="2">
	...
	?>
		<table width="300" border="1">
			...
			<tr>
				<td width="100">会員名</td>
				<td width="200" align="left">&nbsp;<?php echo $c_login_id;?>様</td>
			</tr>
			<tr>
				<td colspan="2">
