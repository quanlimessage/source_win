			...
			<table width="520px"  border="0" cellspacing="2" cellpadding="5" bgcolor="#999999">
			  <tr>
			   ...
			   <tr bgcolor="#FFFFFF" align="left">
				<td>お問い合わせ項目<span style="color:crimson;">（必須）</span></td>
				<td>
					<input type="checkbox" name="inq[]" value="商品について" id="inq1"><label for="inq1">商品について</label><br>
					<input type="checkbox" name="inq[]" value="採用について" id="inq2"><label for="inq2">採用について</label><br>
					<input type="checkbox" name="inq[]" value="見積もり" id="inq3"><label for="inq3">見積もり</label><br>
					<input type="checkbox" name="inq[]" value="その他" id="inq4"><label for="inq4">その他</label><br>
				</td>
			  </tr>
			   <tr bgcolor="#FFFFFF" align="left">
