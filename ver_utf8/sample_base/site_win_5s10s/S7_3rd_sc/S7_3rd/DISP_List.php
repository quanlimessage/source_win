				...
				<?php
					...
					if(!file_exists($img)){
						...
						//画像サイズが固定でない場合（サイズ自動調整、横固定縦可変など）
							...
							$image = "<a href=\"./?id=".urlencode($id)."&p={$p}&ca={$ca}\"><img src=\"".$img."?r=".rand()."\" width=\"".$size[0]."\" height=\"".$size[1]."\" alt=\"".$fetch[$i+$j]['TITLE']."\" border=\"0\"></a>";
					...
					//詳細ページへのリンク
						$detail = "<a href=\"./?id=".urlencode($id)."&p={$p}&ca={$ca}\"><img src=\"../image/detail.jpg\" alt=\"詳細\" border=\"0\"></a>";
