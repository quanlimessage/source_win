...
<div id="content">
	...
	<br>
		...
		<a name="mf"></a>
	   <form method="post" action="./#mf" onSubmit="return inputChk(this,true)" enctype="multipart/form-data">>
		<table width="520px"  border="0" cellspacing="2" cellpadding="5" bgcolor="#999999">
		  ...
		  <?php for($i = 0; $i < $attachNum;$i++){ ?>
		  <tr bgcolor="#FFFFFF" align="left">
		    <td>画像<?php echo $i+1; ?><?php if($i==0){ ?><span style="color:crimson;">（必須）</span><?php } ?></td>
		    <td><input name="up_file[<?php echo $i; ?>]" type="file"></td>
		  </tr>
		  <?php } ?>
		  <tr bgcolor="#FFFFFF" align="left">
			<td colspan="2">
