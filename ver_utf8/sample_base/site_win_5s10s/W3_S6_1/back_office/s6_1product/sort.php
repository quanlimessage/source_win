...
// 設定ファイル＆共通ライブラリの読み込み
require_once("../../common/config_S6_1.php");	// 設定情報
...
<p class="page_title"><?php echo S6_1TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
			...
			<tr class="<?php echo (($i % 2)==0)?"other-td":"otherColTd";?>">
				...
				<td align="center">
					<?php if(file_exists(S6_1IMG_PATH.$fetch[$i]['RES_ID'].'_1.jpg')):?>
						<img src="<?php echo S6_1IMG_PATH.$fetch[$i]['RES_ID'];?>_1.jpg?r=<?php echo rand();?>" border="0" width="<?php echo S6_1IMGSIZE_SX;?>">
					<?php else:?>
						&nbsp;
					<?php endif;?>
				</td>
