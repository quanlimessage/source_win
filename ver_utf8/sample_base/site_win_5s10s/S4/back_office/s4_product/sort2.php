...
// 設定ファイル＆共通ライブラリの読み込み
require_once("../../common/config_S4.php");	// 設定情報
...
<p class="page_title"><?php echo S4_TITLE;?>：並び替え</p>
<p class="explanation">
▼現在表示されている並び順です。<br>
	...
	<td width="60%" valign="top">
		<table width="100%" border="1" cellpadding="2" cellspacing="0" style="height:inherit;">
			<tr class="tdcolored">
				...
				<th width="10%" nowrap class="back2">before</th>
				<th width="10%" nowrap class="back2">after</th>
		...
		<tr>
			...
			<div style="float:left;margin-right:0.5em">
				...
				for($i=0;$i<count($fetch);$i++){
				    ...
				    //$titel_edit =  mb_substr($fetch[$i]['TITLE'], 0, 20);
