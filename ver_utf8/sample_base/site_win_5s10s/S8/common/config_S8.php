...
define('CATE_TITLE','商品紹介子カテゴリーの更新');	// Sx系（商品紹介）カテゴリーのタイトル
define('PARENT_CATE_TITLE','商品紹介親カテゴリーの更新');	// Sx系（商品紹介）カテゴリーのタイトル
...
# データベースでのテーブル名の指定
#=================================================================================
define('S8_PARENT_CATEGORY_MST','S8_PARENT_CATEGORY_MST');	//親カテゴリー
define('S8_CATEGORY_MST','S8_CATEGORY_MST');	//カテゴリー
define('S8_PRODUCT_LST','S8_PRODUCT_LST');		//商品データ
...
//定数を配列に格納しておく（back_office/s8_product/LGC_regist.phpで使用）
